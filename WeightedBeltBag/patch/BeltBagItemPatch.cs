...
public class BeltBagItemPatch
{
    ...
    [HarmonyPatch(nameof(BeltBagItem.RemoveFromBagLocalClientNonElevatorParent))]
    [HarmonyPrefix]

    private static bool OnRemoveFromBagElevator(ref BeltBagItem __instance, object[] __args)
    {
